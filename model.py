...
def cvd_female_raw(age, b_AF, b_atypicalantipsy, b_corticosteroids, b_impotence2, b_migraine, b_ra, b_renal, b_semi, b_sle, b_treatedhyp, b_type1, b_type2, bmi, ethrisk, fh_cvd, rati, sbp, sbps5, smoke_cat, surv, town):
    survivor = np.array([
        0,
        0,
        0,
    ...
    Iethrisk = np.array([0, 0, 0.78079534332995425, 0.56298994142075398, 0.29590000851116516, 0.07278537987798255, -0.17072135508857317, -0.39371043314874971, -0.32632495283530272, -0.17127056883241784])
...
def cvd_male_raw(age, b_AF, b_atypicalantipsy, b_corticosteroids, b_impotence2, b_migraine, b_ra, b_renal, b_semi,
    ...
    Iethrisk = [0, 0, 0.78079534332995425, 0.47446360714931268, 0.52961729919689371, 0.035100159186299017,
